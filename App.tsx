...
<section id="contact" className="py-20 md:py-32 bg-white relative">
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    <div className="bg-indigo-600 rounded-3xl md:rounded-[4rem] 
      p-6 sm:p-10 md:p-24 
      flex flex-col lg:flex-row 
      items-center justify-between gap-12 relative overflow-hidden 
      shadow-2xl shadow-indigo-100">

      {/* Glow */}
      <div className="absolute top-0 right-0 w-60 h-60 md:w-80 md:h-80 bg-white/10 rounded-full blur-[100px] -mr-32 -mt-32"></div>

      {/* LEFT */}
      <div className="flex-1 text-center lg:text-left text-white relative z-10">
        <h2 className="text-3xl sm:text-4xl md:text-7xl 
      ...
      <div className="flex-1 w-full relative z-10">
        <div className="bg-white rounded-2xl sm:rounded-3xl md:rounded-[3.5rem] 
          p-6 sm:p-10 md:p-14 shadow-3xl text-slate-900 text-center">
          ...
          <a
            href="https://zalo.me/0943304685"
            target="_blank"
            className="block w-full py-4 md:py-6 bg-[#0068ff] text-white font-black rounded-2xl md:rounded-3xl 
              hover:bg-[#0052cc] transition-all shadow-xl shadow-blue-200 
              text-sm md:text-lg uppercase tracking-widest active:scale-95"
          >
            CHAT QUA ZALO NGAY
          </a>
...
<div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[999]">
  <a
    href="https://zalo.me/0943304685"
    target="_blank"
    className="w-14 h-14 md:w-16 md:h-16 bg-[#0068ff] text-white rounded-full flex items-center justify-center 
      shadow-2xl hover:scale-110 transition-all animate-bounce-slow active:scale-90"
  >
